...
git clone https://github.cms.gov/CMSgov/cms-ars-3.1-low-canonical-ubuntu-16.04-lts-stig-overlay.git
cd cms-ars-3.1-low-canonical-ubuntu-16.04-lts-stig-overlay
bundle install
cd ..
inspec exec cms-ars-3.1-low-canonical-ubuntu-16.04-lts-stig-overlay --input-file cms-ars-3.1-low-canonical-ubuntu-16.04-lts-stig-overlay/static-inputs.yml [-t ssh://<hostname>:<port> --sudo] --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
To report a bug or feature request, please open an [issue](https://github.cms.gov/CMSgov/cms-ars-3.1-low-canonical-ubuntu-16.04-lts-stig-overlay/issues/new).
